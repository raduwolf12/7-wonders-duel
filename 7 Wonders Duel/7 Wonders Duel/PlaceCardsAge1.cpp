...
void PlaceCardsAge1::PlaceCards(AgeICards& age)
{
	this->age1 = age;
	auto age1deck = age1.GetDeck();
	for (int index = 0; index < kNoCardsFirstLine; ++index)
	{
		m_placeCards.at(index) = { age1deck.at(index),"Accessible" };
	}
	for (int index = kNoCardsFirstLine; index < kNoCardsPlaced; ++index)
	{
		m_placeCards.at(index) = { age1deck.at(index),"Inaccessible" };
	}
}

void PlaceCardsAge1::MakeAccessibleCards()
{
	if (m_placeCards.at(0).second == "Taken" && m_placeCards.at(1).second == "Taken"&& m_placeCards.at(6).second!= "Taken")
	{
		m_placeCards.at(6).second = "Accessible";
	}
	if (m_placeCards.at(1).second == "Taken" && m_placeCards.at(2).second == "Taken" && m_placeCards.at(7).second != "Taken")
	{
		m_placeCards.at(7).second = "Accessible";

	}
	if (m_placeCards.at(2).second == "Taken" && m_placeCards.at(3).second == "Taken" && m_placeCards.at(8).second != "Taken")
	{
		m_placeCards.at(8).second = "Accessible";

	}
	if (m_placeCards.at(3).second == "Taken" && m_placeCards.at(4).second == "Taken" && m_placeCards.at(9).second != "Taken")
	{
		m_placeCards.at(9).second = "Accessible";

	}
	if (m_placeCards.at(4).second == "Taken" && m_placeCards.at(5).second == "Taken" && m_placeCards.at(10).second != "Taken")
	{
	...
	if (m_placeCards.at(8).second == "Taken" && m_placeCards.at(9).second == "Taken" && m_placeCards.at(13).second != "Taken")
	{
		m_placeCards.at(13).second = "Accessible";

	}
	if (m_placeCards.at(9).second == "Taken" && m_placeCards.at(10).second == "Taken" && m_placeCards.at(14).second != "Taken")
	{
...
void PlaceCardsAge1::AccessibleCards()
{
...
void PlaceCardsAge1::DiscardCard(Card card)
{
	for (int index = 0; index < kNoCardsPlaced; ++index)
	{
